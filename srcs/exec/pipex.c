...
/*   Updated: 2024/03/31 06:45:02 by kboulkri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	redirection(t_data *data, t_token *tok, t_heredoc *h_docs, int i)
{
	if (i != 0)
	{
		dup2(data->tmp_fd, 0);
